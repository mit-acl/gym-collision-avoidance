...
class SingleIntegratorDynamics(Dynamics):
    ...
    def step(self, action, dt):
        ...
        Args:
            action (list): [v_x, v_y] command for this agent
        ...
        A = np.array([[1, 0], [0, 1]])
        B = np.array([[1, 0], [0, 1]])
        x_t = self.agent.rel_pos_to_goal
        x_t1 = A@x_t + dt*B@action

        self.agent.pos_global_frame = x_t1 + self.agent.goal_global_frame

        # TODO: Set agent velocity
        # TODO: Set agent speed
        # TODO: Set agent heading
        # TODO: Set agent turning dir?
